...
class Problem {
    ...
    public static ArrayList<String> numericalLetterGrade(ArrayList<Float> grades) {
        ...
        return grades.stream().map(x -> x > 4 ? "A+" : x > 3.7 ? "A" : x > 3.3 ? "A-" : x > 3 ? "B+" : x > 2.7 ? "B" : x > 2.3 ? "B-" : x > 2 ? "C+" : x > 1.7 ? "C" : x > 1.3 ? "C-" : x > 1 ? "D+" : x > 0.7 ? "D" : x > 0 ? "D-" : "E").collect(Collectors.toCollection(ArrayList::new));
    }
