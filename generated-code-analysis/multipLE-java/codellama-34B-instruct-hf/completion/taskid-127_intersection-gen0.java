...
class Problem {
    ...
    public static String intersection(Pair<Long, Long> interval1, Pair<Long, Long> interval2) {
        ...
        var start = interval1.getValue0() > interval2.getValue0() ? interval1.getValue0() : interval2.getValue0();
        var end = interval1.getValue1() < interval2.getValue1() ? interval1.getValue1() : interval2.getValue1();
