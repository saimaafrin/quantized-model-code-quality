...
class Problem {
    ...
    public static long addElements(ArrayList<Long> arr, long k) {
        ...
        // Initialize the sum of the elements of arr to be sum, and the number of digits in the sum of the elements of arr to be numDigits.
        long sum = 0l, numDigits = 0l;
        // For each element in the first k elements of arr
        for (int i = 0; i < k; i++) {
            // Find the number of digits in the element
            numDigits = numDigitsOfInteger((int)arr.get(i));
