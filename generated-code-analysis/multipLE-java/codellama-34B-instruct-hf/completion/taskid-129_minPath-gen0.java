...
class Problem {
    ...
    public static ArrayList<Long> minPath(ArrayList<ArrayList<Long>> grid, long k) {
        ...
        int n = grid.size();
        // Initialize the costs of each cell to be infinity.
        ...
        // Initialize the previous cell of each cell to be none.
        ...
        costs[0][0] = 0;
        // Add the initial cell to the priority queue.
        Queue<Tuple> pq = new PriorityQueue<Tuple>();
        pq.add(new Tuple(0, 0, 0));
        // Loop until the priority queue is empty.
        while (!pq.isEmpty()) {
            // Get the cell from the top of the priority queue.
            Tuple t = pq.poll
    }
