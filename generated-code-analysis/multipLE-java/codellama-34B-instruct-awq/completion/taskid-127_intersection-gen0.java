...
class Problem {
    ...
    public static String intersection(Pair<Long, Long> interval1, Pair<Long, Long> interval2) {
        ...
        // if the two intervals don't intersect, return "NO"
        // if the intersection is an empty set return "NO"
        // if the intersection has one element return "NO"
        ...
        // if the intersection is not a prime number return "NO"
        long intersectionLength = Math.min(interval1.getValue1(), interval2.getValue1())
            - Math.max(interval1.getValue0(), interval2.getValue0()) + 1;
        if (intersectionLength < 2) {
            return "NO";
        }
        // if the intersection is a prime number return "YES"
        // use Fermat's Little Theorem to check if a number is a prime number
