...
class Problem {
    ...
    public static Optional<Long> nextSmallest(ArrayList<Long> lst) {
        ...
        var min1 = lst.stream().min((a, b) -> Long.compare(a, b));
        if (min1.isEmpty()) return Optional.empty();
        var min2 = lst.stream().filter(a -> Long.compare(a, min1.get()) < 0).min((a, b) -> Long.compare(a, b));
        return min2;
    }
