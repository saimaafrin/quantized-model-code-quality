...
class Problem {
    ...
    public static ArrayList<Long> tri(long n) {
        ...
        if (n == 0) {
            ...
            ArrayList<Long> tribonacci = tri((long)(n - 1l));
            if (n % 2l == 0l) {
                tribonacci.add((long)1l + (n / 2l));
            } else {
                tribonacci.add((long)(tribonacci.get((int)(tribonacci.size() - 1l))) + (long)(tribonacci.get((int)(tribonacci.size() - 2l))) + (long)(tribonacci.get((int)(tribonacci.size() - 3l))));
            }
            return tribonacci;
        }
    }
