...
class Problem {
    ...
    public static Pair<Float, Float> findClosestElements(ArrayList<Float> numbers) {
        ...
        // The idea is to use streams to sort the numbers from smallest to largest. Then, we can compare pairs of
        // elements to find the closest two.
        ArrayList<Pair<Float, Float>> sortedPairs = numbers.stream()
            .sorted()
            .map(f -> Pair.with(f, f))
            .collect(Collectors.toCollection(ArrayList::new));
        // Now, we need to find the closest pair in sortedPairs. The first pair is the closest pair, so we can return
        // the first pair in sortedPairs.
