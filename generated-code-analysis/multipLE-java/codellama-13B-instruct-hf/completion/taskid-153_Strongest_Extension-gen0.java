...
class Problem {
    ...
    public static String StrongestExtension(String class_name, ArrayList<String> extensions) {
        ...
        double strongestStrength = Double.NEGATIVE_INFINITY;
        for (String extension : extensions) {
            double strength = (double) extension.chars().filter(Character::isUpperCase).count() - extension.chars().filter(Character::isLowerCase).count();
