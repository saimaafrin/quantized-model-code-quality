...
class Problem {
    ...
    public static ArrayList<Long> uniqueDigits(ArrayList<Long> x) {
        ...
        // your code here
        ArrayList<Long> a = x.stream().filter(d->d.toString().matches("^[0135679]+$")).collect(Collectors.toCollection(ArrayList::new));
        return a.stream().sorted().collect(Collectors.toCollection(ArrayList::new));
    }
