...
class Problem {
    ...
    public static ArrayList<String> oddCount(ArrayList<String> lst) {
        ...
        for (String s : lst) {
            ...
            String res = "the number of odd elements " + Integer.toString(count) + "n the str" + Integer.toString(count) + "ng " + Integer.toString(count) + " of the " + Integer.toString(count) + "nput.";
            result.add(res);
        }
        return result;
    }
