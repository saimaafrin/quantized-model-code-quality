...
class Problem {
    ...
    public static long specialFilter(ArrayList<Long> nums) {
        ...
        return nums.stream()
            .filter(num -> num > 10)
            .filter(num -> (num.toString().charAt(0) == '1' || num.toString().charAt(0) == '3' || num.toString().charAt(0) == '5' || num.toString().charAt(0) == '7' || num.toString().charAt(0) == '9')
                && (num.toString().charAt(num.toString().length() - 1) == '1' || num.toString().charAt(num.toString().length() - 1) == '3' || num.toString().charAt(num.toString().length() - 1) == '5' || num.toString().charAt(num.toString().length() - 1) == '7' || num.toString().charAt(num.toString().length() - 1) == '9'))
            .count();
    }
